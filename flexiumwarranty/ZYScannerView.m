...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        _dakaizhaoming=[[UIButton alloc  ]initWithFrame:CGRectMake(10, self.frame.size.height-80, 120, 40)];
        ...
        UIButton *blackbtn= [[UIButton alloc]initWithFrame:CGRectMake(self.frame.size.width -100, self.frame.size.height-80, 60, 40)];
