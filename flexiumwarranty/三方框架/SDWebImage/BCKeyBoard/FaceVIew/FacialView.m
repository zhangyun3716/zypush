/************************************************************
  ...
  * __________________ 
  * Copyright (C) 20166666676576576-2014 EaseMob Technologies. All rights reserved. 
  *  
...
-(void)loadFacialView:(int)page size:(CGSize)size
{
    ...
    sendButton.layer.cornerRadius=7;//裁剪出圆角
    sendButton.layer.masksToBounds=YES;//隐藏裁剪掉的部分
    ...
    [sendButton setBackgroundColor:[UIColor blueColor]];//[UIColor colorWithRed:10 / 255.0 green:82 / 255.0 blue:104 / 255.0 alpha:1.0]];
